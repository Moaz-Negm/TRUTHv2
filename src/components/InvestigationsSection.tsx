...
export default function InvestigationsSection({ onArticleClick }: InvestigationsSectionProps) {
  return (
    <>
      {/* Dotted border separator on top of investigations section */}
      <div className="border-t border-dotted border-blue-200 w-full mb-2" style={{ height: '0px' }}></div>
        ...
        <div className="flex items-center justify-between mb-8 pb-4">
          <div className="flex items-center gap-2 select-none title-accent-group">
            ...
            <div className="flex items-center gap-2 title-accent-content">
              <span className="w-3.5 h-3.5 bg-[#155EE7] title-accent-span" style={{ borderRadius: 0 }} id="title-accent-investigations"></span>
              <h2
                style={{
